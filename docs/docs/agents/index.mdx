...
First, make sure the Jupyter AI Agent is installed (refer to the [installation guide](/docs/install)). Make sure you understand the different [**deployment modes**](/docs/deployments) referring to where the agent is running, and the [**interactions modes**](/docs/interactions) referring to how the agent is used.
...
- [Explain Error Agent](/docs/explain_error): Explains the first error encountered in a notebook.
